...
var DATA = {
  ...
  lieux: [
    ...
    { id:70, nom:"Bivouac désert Merzouga", nom_en:"Merzouga Desert Bivouac", nom_ar:"مخيم صحراء مرزوكة", ville:"Merzouga", cat:"Aventure", img:"images/Bivouac_Merzouga.jpg", maps_url:"https://maps.google.com/?q=Desert+Bivouac+Merzouga", desc_fr:"Passer une nuit sous les étoiles du Sahara dans un campement de tentes berbères.", desc_en:"Spend a night under Sahara stars in a Berber tent camp.", desc_ar:"قضاء ليلة تحت نجوم الصحراء في مخيم خيام أمازيغية." },
    { id:71, nom:"Village de Hassilabied", nom_en:"Hassilabied Village", nom_ar:"قرية حسي لبيض", ville:"Merzouga", cat:"Culture", img:"images/Hassilabied.jpg", maps_url:"https://maps.google.com/?q=Hassilabied+Merzouga", desc_fr:"Village traditionnel berbère aux pieds des dunes de l'Erg Chebbi.", desc_en:"Traditional Berber village at the foot of the Erg Chebbi dunes.", desc_ar:"قرية أمازيغية تقليدية عند أقدام كثبان إرق الشبي." },
    ...
    { id:75, nom:"Parc National Ifrane", nom_en:"Ifrane National Park", nom_ar:"الحديقة الوطنية إفران", ville:"Ifrane", cat:"Nature", img:"images/Parc_Ifrane.jpg", maps_url:"https://maps.google.com/?q=Ifrane+National+Park", desc_fr:"Parc naturel de 125 000 hectares avec des forêts de cèdres et cerfs de Barbarie.", desc_en:"Natural park of 125,000 hectares with cedar forests and Barbary deer.", desc_ar:"حديقة وطنية تبلغ مساحتها 125000 هكتار بغابات الأرز." },
    { id:76, nom:"Plage de Taghazout", nom_en:"Taghazout Beach", nom_ar:"شاطئ تغاوت", ville:"Taghazout", cat:"Plage", img:"images/Plage_Taghazout.jpg", maps_url:"https://maps.google.com/?q=Taghazout+Beach", desc_fr:"La plage principale de Taghazout avec ses vagues parfaites pour le surf.", desc_en:"Taghazout's main beach with perfect waves for surfing.", desc_ar:"الشاطئ الرئيسي لتغاوت بأمواجه المثالية للتزلج." },
    { id:77, nom:"Anchor Point Taghazout", nom_en:"Anchor Point", nom_ar:"نقطة الارتكاز", ville:"Taghazout", cat:"Surf", img:"images/Anchor_Point.jpg", maps_url:"https://maps.google.com/?q=Anchor+Point+Taghazout", desc_fr:"L'un des meilleurs spots de surf d'Afrique avec des vagues de droite pouvant atteindre 4 mètres.", desc_en:"One of Africa's best surf spots with right-hand waves up to 4 metres.", desc_ar:"أحد أفضل مواقع ركوب الأمواج في أفريقيا." },
...
,
    ...
    { id:81, nom:"Dunes atlantiques Dakhla", nom_en:"Dakhla Atlantic Dunes", nom_ar:"كثبان الداخلة الأطلسية", ville:"Dakhla", cat:"Nature", img:"images/Dakhla_Dunes.jpg", maps_url:"https://maps.google.com/?q=Dakhla+Dunes", desc_fr:"Dunes de sable dorées qui rencontrent l'océan Atlantique — un paysage unique au monde.", desc_en:"Golden sand dunes meeting the Atlantic Ocean — a unique landscape worldwide.", desc_ar:"كثبان رملية ذهبية تلتقي بالمحيط الأطلسي — منظر فريد في العالم." },
    { id:82, nom:"Port de Dakhla", nom_en:"Dakhla Port", nom_ar:"ميناء الداخلة", ville:"Dakhla", cat:"Port", img:"images/Dakhla_Port.jpg", maps_url:"https://maps.google.com/?q=Dakhla+Port", desc_fr:"Port de pêche animé où les bateaux ramènent chaque matin homards, crevettes et poissons frais.", desc_en:"Lively fishing port where boats bring back lobsters, shrimps and fresh fish every morning.", desc_ar:"ميناء صيد نابض بالحياة تعود منه القوارب كل صباح بالكركند والروبيان." },
    ...
    { id:87, nom:"Parc National Al Hoceïma", nom_en:"Al Hoceima National Park", nom_ar:"الحديقة الوطنية الحسيمة", ville:"Al Hoceïma", cat:"Nature", img:"images/Al_Hoceima_Parc.jpg", maps_url:"https://maps.google.com/?q=Al+Hoceima+National+Park", desc_fr:"Parc national marin avec des falaises spectaculaires, des grottes marines et une biodiversité exceptionnelle.", desc_en:"Marine national park with spectacular cliffs, sea caves and exceptional biodiversity.", desc_ar:"حديقة وطنية بحرية بجروف رائعة وكهوف بحرية وتنوع بيولوجي استثنائي." },
    { id:88, nom:"Remparts d'Asilah", nom_en:"Asilah Ramparts", nom_ar:"أسوار أصيلة", ville:"Asilah", cat:"Patrimoine", img:"images/Asilah_Remparts.jpg", maps_url:"https://maps.google.com/?q=Asilah+Ramparts", desc_fr:"Remparts portugais du 15e siècle dominant l'Atlantique, entourés de fresques murales contemporaines.", desc_en:"15th century Portuguese ramparts overlooking the Atlantic, surrounded by contemporary murals.", desc_ar:"أسوار برتغالية من القرن الخامس عشر تطل على الأطلسي محاطة بجداريات معاصرة." },
    ...
    { id:94, nom:"Plage de Sidi Ifni", nom_en:"Sidi Ifni Beach", nom_ar:"شاطئ سيدي إفني", ville:"Sidi Ifni", cat:"Plage", img:"images/Sidi_Ifni_Plage.jpg", maps_url:"https://maps.google.com/?q=Sidi+Ifni+Beach", desc_fr:"Longue plage sauvage face à l'Atlantique avec de bonnes vagues pour le surf.", desc_en:"Long wild beach facing the Atlantic with good waves for surfing.", desc_ar:"شاطئ طويل برية على الأطلسي بأمواج جيدة للتزلج." }  ],
